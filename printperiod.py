...
def incavg(arr, inc):
    ...
    return ret
while True:
    color = ['r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k','r','g','b','c','m','y','k']
    dudy = [[[],[]]]
    file_names = files()
    for i in range(len(file_names)):
        ...
        for index in range(len(lists)):
            if type(lists[index]) is float:
                dudy[i][0] += [lists[index]]*len(lists[index+1])
            else:
